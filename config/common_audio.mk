...
ALARM_PATH := vendor/aim/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/aim/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/aim/prebuilt/common/media/audio/ringtones
